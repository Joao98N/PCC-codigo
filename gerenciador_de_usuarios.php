...
// Verificação 1
	if($parametro){
		$dados = mysqli_query($conexao, "SELECT * FROM usuarios WHERE nivel like '$parametro%' ORDER BY nivel");	
	}
// Verificação 2
	else {
		$dados = mysqli_query($conexao, "SELECT * FROM usuarios ORDER BY nivel");
	}
    ...
    <body>
                                ...
                                <div class="card">
                                    <div class="card-block">
                                        <div class="card-title-block">
                                            <h3 class="title"> Gerencia de usuários</h3>
                                        </div>
                                        <section class="example">
                                            <div class="table-responsive">
											<form action="gerenciador_de_usuarios.php">
													<input type="text" name="parametro"/>
													<input type="submit" value="Buscar usuário por nível" class="btn btn-primary"/>
												</form>
		...
		?>
                    ...
                    <tr>
						...
						<td><a href="<?php echo "paginaalterar.php?id=" . $linha['id'] . "&nivel=" . $linha['nivel']?>">Alterar</a></td>
