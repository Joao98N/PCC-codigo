                                ...
                                <div class="card sameheight-item stats" data-exclude="xs">
                                    <div class="card-block">
                                        <div class="title-block">
                                            <h4 class="title"> Alterando o  nível  de acesso </h4>
                                            <p class="title-description"> De  acordo  com o nível  de acesso escolhido por você o usuário cadastrado poderá acessar os dados que lhe dão respeito.</p>
												<br>0 = Conta não validada/suspensa;<br>
			1 = Docente;<br>
			2 = Propedêutico;<br>
			3 = Aluno;<br><br>
												<form action="alterar.php">
				<input type="hidden" name="id" value="<?php echo $id ?>" />
				Novo nível: 	<input type="text" name="nivel" value="<?php echo $nivel ?>" />
