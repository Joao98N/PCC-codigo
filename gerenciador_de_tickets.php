...
// Verificação 1
	if($parametro){
		$dados = mysqli_query($conexao, "SELECT * FROM ticket WHERE tk_id like '$parametro%' ORDER BY tk_id");	
	}
// Verificação 2
	else {
		$dados = mysqli_query($conexao, "SELECT * FROM ticket ORDER BY tk_id");
	}
                                    ...
                                    <div class="card-block">
                                        <div class="title-block">
                                            ...
                                            <p class="title-description"> Insira os dados para cadastrar a ocorrência.</p>
												<form name="cadastro_de_ocorrencia" method="post" action="validacao_c_ocorrencia1.php">
<fieldset>
<br>
<table>
...
<tr>
	...
	<td><input type="reset" value="Limpar Dados" class="btn btn-primary"></td>
                                ...
                                <div class="card">
                                    <div class="card-block">
                                        <div class="card-title-block">
                                            <h3 class="title"> Tabela com tickets </h3>
                                        </div>
										<form action="gerenciador_de_tickets.php">
													<input type="text" name="parametro"/>
													<input type="submit" value="Buscar ticket por ID" class="btn btn-primary"/>
												</form>
		...
		?>
                    ...
                    <tr>
						<td><?php echo $linha['tk_id'] ?></td>
						<td><?php echo $linha['tk_nome'] ?></td>
						
						<td><?php echo $linha['tk_data'] ?></td>
						<td><?php echo $linha['tk_turno'] ?></td>
						<td><?php echo $linha['tk_ocorrido'] ?></td>
						<td><?php echo $linha['tk_turma'] ?></td>
						<td><?php echo $linha['tk_envolvidos'] ?></td>
		<?php
