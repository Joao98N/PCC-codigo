...
?>
       ...
       //Inicia cessão
		...
		// Selecionando Todos os dados onde oc_email = $matricula1
		
			$dadosMatricula = mysqli_query($conexao, "SELECT * FROM ocorrencias INNER JOIN    usuarios ON ocorrencias.oc_matricula = usuarios.matricula WHERE oc_matricula = $matricula1");
